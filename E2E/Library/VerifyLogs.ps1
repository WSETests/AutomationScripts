...
{  
   ...
   {   
      ...
      {             
          ...
          #As memory usage event are added on recent PC version
          if ($frameProcessingDetails.Count -gt 29)
          {
   ...
   {  
      ...
      if (Test-path -Path $pathAsgTraceTxt)
      {
         ...
         else
         {
            ...
            Write-Host "   [ScenarioID:$snarioId] was not found.`n   AsgTraceLog saved here: $pathAsgTraceLogs" -ForegroundColor Yellow
